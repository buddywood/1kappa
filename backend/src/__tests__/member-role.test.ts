...
describe('Member Role Functionality', () => {
  ...
  describe('Connect Directory Search', () => {
    it('should return verified members only', async () => {
      ...
      expect(response.body[0]).toHaveProperty('verification_status', 'VERIFIED');
  ...
  describe('Steward Marketplace Access', () => {
    ...
    it('should require verified member status for marketplace', async () => {
      ...
      expect(response.body).toHaveProperty('error', 'Verified member status required');
    });
  });

  describe('Steward Listing Claim', () => {
    it('should allow verified members to claim steward listings', async () => {
  ...
  describe('Steward Checkout Session', () => {
    it('should create checkout session for verified members', async () => {
      const { getStewardListingById, getStewardById, getChapterById, getPlatformSetting } = require('../db/queries');
  ...
  describe('Role Transitions', () => {
    it('should allow members to apply to become sellers', async () => {
    ...
    it('should allow members to apply to become promoters', async () => {
    ...
    it('should allow members to apply to become stewards', async () => {
