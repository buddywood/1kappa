...
export class Seller extends BaseModel {
  ...
  // Updated in migration 20250101000013 to TEXT to support comma-separated values
  @Column({
    type: DataType.TEXT,
    allowNull: true,
  })
  merchandise_type!: string | null; // Can be single value or comma-separated like "KAPPA,NON_KAPPA"
