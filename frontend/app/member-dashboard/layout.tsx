...
const sidebarItems = [
  { href: '/member-dashboard', label: 'Dashboard Home', icon: LayoutDashboard },
  { href: '/connect', label: 'Connect', icon: Users },
  { href: '/profile', label: 'Profile Settings', icon: Settings },
  { href: '/member-dashboard/help', label: 'Help Center', icon: HelpCircle },
];
...
export default function MemberDashboardLayout({
  ...
  // Check if user has seller, promoter, or steward roles
  ...
  if (isSeller) {
    conditionalItems.push({ href: '/seller-dashboard', label: 'Seller Dashboard', icon: Store });
  }
  if (isPromoter) {
    conditionalItems.push({ href: '/promoter-dashboard', label: 'Promoter Dashboard', icon: Megaphone });
  }
  if (isSteward) {
    conditionalItems.push({ href: '/steward-dashboard', label: 'Steward Dashboard', icon: Shield });
  }
