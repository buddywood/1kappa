...
import AddressFieldAutocomplete from "../components/AddressFieldAutocomplete";
                  ...
                  <div>
                    <div className="flex gap-2 items-start">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-midnight-navy text-white rounded-lg hover:bg-midnight-navy/90 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 whitespace-nowrap mt-8"
                    ...
                    <p className="text-xs text-midnight-navy/60 mt-1">
                      Start typing to see address suggestions, or click
                      &quot;Detect&quot; to automatically fill your location
                      using your device&apos;s GPS
                    </p>
                  </div>
                ) : (
                  <>
