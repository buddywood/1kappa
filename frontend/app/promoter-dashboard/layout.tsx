...
const sidebarItems = [
  { href: '/promoter-dashboard', label: 'Dashboard Home', icon: LayoutDashboard },
  { href: '/promoter-dashboard/events', label: 'My Events', icon: Calendar },
  { href: '/promoter-dashboard/events/create', label: 'Create Event', icon: PlusCircle },
  { href: '/promoter-dashboard/analytics', label: 'Analytics', icon: BarChart3 },
  { href: '/profile', label: 'Profile Settings', icon: Settings },
  { href: '/promoter-dashboard/help', label: 'Help Center', icon: HelpCircle },
];
