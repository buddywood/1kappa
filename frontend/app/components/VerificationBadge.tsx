...
export default function VerificationBadge({
  ...
  if (type === "brother") {
    return (
      <div
        className={`inline-flex items-center gap-1.5 bg-aurora-gold/20 text-aurora-gold px-2.5 py-1 rounded-full text-xs font-semibold border border-aurora-gold/30 ${className}`}
      >
        <svg
          width="12"
          height="12"
  ...
  if (type === "initiated-chapter") {
    ...
    return (
      <div
        className={`inline-flex items-center gap-1.5 bg-white text-crimson px-2.5 py-1 rounded-full text-xs font-semibold border border-frost-gray ${className}`}
      >
        <svg
          width="12"
          height="12"
        ...
        <span>
          Initiated at{" "}
          <span className="font-bold">{chapterName || "Chapter"}</span> chapter
          {seasonYear}
        </span>
      </div>
    );
  ...
  if (type === "seller") {
    return (
      <div
        className={`inline-flex items-center gap-1.5 bg-slate-500/15 text-slate-600 dark:text-slate-400 px-2.5 py-1 rounded-full text-xs font-semibold border border-slate-500/25 ${className}`}
      >
        <svg
          width="12"
          height="12"
